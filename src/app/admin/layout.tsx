...
export default async function AdminLayout({
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden text-foreground">
      {/* Background Ambient for Admin - Slate colors */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-slate-600/5 rounded-full mix-blend-screen filter blur-[100px]" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-slate-800/5 rounded-full mix-blend-screen filter blur-[100px]" />
      </div>

      {/* Sidebar */}
      <aside className="w-64 border-r border-primary/10 bg-background/50 backdrop-blur-xl hidden md:flex flex-col relative z-20">
        <div className="h-20 flex items-center px-6 border-b border-primary/10 shrink-0">
