        ...
        <div className="flex items-center gap-12">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative">
              ...
              <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-[#1a1a1f] to-[#0a0a0b] border border-white/10 flex items-center justify-center transform group-hover:scale-105 transition-transform">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/database" className="text-sm font-medium text-muted-foreground hover:text-white transition-colors flex items-center gap-2">
              <BookOpen className="w-4 h-4" /> Database Janji
            </Link>
            <Link href="/ruu-watch" className="text-sm font-medium text-muted-foreground hover:text-white transition-colors flex items-center gap-2">
              <FileText className="w-4 h-4" /> RUU Watch
            </Link>
            <Link href="/promise-radar" className="text-sm font-medium text-muted-foreground hover:text-white transition-colors flex items-center gap-2">
